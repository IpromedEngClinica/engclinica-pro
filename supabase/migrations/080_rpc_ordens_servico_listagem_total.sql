-- ============================================================
-- EngClinica Pro
-- Migration: 080_rpc_ordens_servico_listagem_total.sql
-- Objetivo:
-- - Devolver total real na listagem rapida de ordens de servico
-- - Corrigir navegacao entre paginas na tabela de OS
-- ============================================================
...
-- Fim da migration 080_rpc_ordens_servico_listagem_total.sql
